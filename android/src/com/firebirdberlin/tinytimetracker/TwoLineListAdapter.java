...
public class TwoLineListAdapter extends ArrayAdapter<String> {
    private Context mContext = null;
    private List<String> values1 = null;
    private List<String> values2 = null;

    public TwoLineListAdapter(Context context, int viewid, List<String> values1, List<String> values2) {
